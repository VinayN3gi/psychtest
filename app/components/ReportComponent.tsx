  ...
  return (
    <div className=' mt-5'>
        ...
        <div className=' mt-5 mb-5'>
            ...
            <p className='mt-2 text-xl text-zinc-800'>Purpose of the report</p>
            ...
            <p className=' mt-5 text-xl text-zinc-900 '>Assesment overview</p>
            <p className=' mt-3 text-md text-zinc-900'>The assessment consist of five key sections :</p>
            <ul className='list-decimal ml-5 mt-3'>
                <li> <span className=' font-bold '>Interest Inventory : </span>Evaluates your prefrences for various activities and types of work</li>
                <li><span className=' font-bold'>Personality Trailts : </span>Assesses aspects of your personality that influence career suitability and satisfaction. </li>
                <li> <span className=' font-bold'>Skills Assesment : </span>Identifies your key strengths and areas for improvement across different skills.</li>
                <li><span className=' font-bold'>Values Assesment : </span>Examines the core values that drive your career choices.</li>
                <li>
